...
export function App() {
  ...
  const [isGuestsOpenModal, seIsGuestsOpenModal] = useState(false);
  const [emailsToInvite, setEmailsToInvite] = useState(['jose@rocketseat.com.br', 'Jose@gmail.com']);
  ...
  function openGuestModal(){
    seIsGuestsOpenModal(true)
  }

  function closeGuestModal(){
    seIsGuestsOpenModal(false)
  }
    ...
    <div className="h-screen flex items-center justify-center bg-pattern bg-no-repeat bg-center">
      <div className="max-w-2xl w-full px-6 text-center space-y-10">
        ...
        <p className="text-sm text-zinc-500">
          ...
          como nossos <a className="text-zinc-300 underline" href="#">Termos de uso</a> e <a className="text-zinc-300 underline" href="#">Politicas de Privacidade</a>
        </p>
      </div>
